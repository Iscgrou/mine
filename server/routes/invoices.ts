            ...
            <div class="invoice-details">
                <div class="invoice-info">
                    <div class="info-section">
                        ...
                        <div class="info-row">
                            <span class="info-label">تاریخ صدور:</span>
                            <span class="info-value">${invoice.createdAt ? new Date(invoice.createdAt).toLocaleDateString('fa-IR') : ''}</span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">وضعیت:</span>
...
🌐 مارفانت`;
      ...
      const telegramMessage = telegramTemplate
        ...
        .replace(/\{date\}/g, invoice.createdAt ? new Date(invoice.createdAt).toLocaleDateString('fa-IR') : '')
  ...
  app.delete("/api/invoices/delete-all", async (req: any, res: any) => {
    try {
  ...
  // Edit Invoice
  app.patch("/api/invoices/:id", async (req: any, res: any) => {
    try {
      const invoiceId = parseInt(req.params.id);
  ...
  app.post("/api/invoices/calculate-all-commissions", async (req: any, res: any) => {
    try {
  ...
  app.post("/api/invoices/send-all-telegram", async (req: any, res: any) => {
    try {
  ...
  app.post("/api/invoices/archive-all", async (req: any, res: any) => {
    try {
