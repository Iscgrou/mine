/**
 * Settings Component - Complete Reconstruction by Vertex AI
 * Fixes all database persistence and state management issues
 */
...
export default function SettingsVertexFinal() {
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  شناسه چت یا کانال برای ارسال اعلان‌ها
                </p>
              </div>
